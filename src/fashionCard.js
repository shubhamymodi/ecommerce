...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          <div className="row">
          <img className="column" style={{marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://res.cloudinary.com/shubhampersonal/image/upload/v1618769127/fashion_o9qlph.jpg" alt="dp"/>
          
          </div>
          <br/>
          <span style={{fontWeight:"bold"}}>ARROW Solid Formal Men Full Sleeve Blazer  (Blue)</span><br/>
 ...
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={fashion[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
