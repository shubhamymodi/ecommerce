...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          <div className="row">
          <img className="column" style={{marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://res.cloudinary.com/shubhampersonal/image/upload/v1618768656/sofa_abskit.jpg" alt="dp"/>
          
          </div>
          <br/>
          <span style={{fontWeight:"bold"}}>Flipkart Perfect Homes Burano Fabric 3 Seater Sofa  (Finish Color - Orange)</span><br/>
 ...
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={house[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
