...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          <div className="row">
          <img className="column" style={{marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://res.cloudinary.com/shubhampersonal/image/upload/v1618765374/m21s_cs6l4w.jpg" alt="dp"/>
          
          </div>
          <br/>
          <span style={{fontWeight:"bold"}}>SAMSUNG Galaxy M12 (Black, 128 GB)  (6 GB RAM)</span><br/>
 ...
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={mobiles[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
