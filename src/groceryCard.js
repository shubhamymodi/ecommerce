...
{/* ----------------------------------------------------------------------------------------------------- */}
        ...
        <DialogContent dividers>
          <div className="row">
          <img className="column" style={{marginLeft:"auto",marginRight:"auto",display:"block"}} src="https://res.cloudinary.com/shubhampersonal/image/upload/v1618768035/maggi_gnq2lt.jpg" alt="dp"/>
          
          </div>
          <br/>
          <span style={{fontWeight:"bold"}}>Maggi 2-Minute Special Masala Instant Noodles Vegetarian</span><br/>
 ...
 <Box style={{marginLeft:"auto",marginRight:"auto",textAlign:"center"}} component="fieldset" mb={3} borderColor="transparent">
         <Rating defaultValue={grocery[i].Rating} precision={0.5} name="read-only" readOnly />
  </Box>
